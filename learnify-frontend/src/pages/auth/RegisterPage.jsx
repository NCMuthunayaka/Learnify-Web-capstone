...
import { GraduationCap, Users, Check, X, Eye, EyeOff } from "lucide-react"
...
function RegisterPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const response = await registerUser(
        fullName, formData.email, formData.password,
        formData.role, formData.qualifications, formData.certifications
      )
  ...
  async function handleRoleConfirm() {
    ...
    try {
      ...
      const target = selectedRole === "mentor"
        ? "/mentor/dashboard"
        : selectedRole === "admin"
        ? "/admin/dashboard"
        : "/dashboard"
